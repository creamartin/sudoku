...
function Privacy(props){
    return (
        <div>
            ...
            <p>
                <span>Sample company/entrepreneur</span>
                <br/>
                <span>Any street 1</span>
                <br/>
                <span>12345 Anytown</span>
                <br/>
                <span>Germany</span>
            </p>
            <p>
                <span>Telephone: Telephone number</span>
                <br/>
                <span>Fax: Fax number</span>
                <br/>
                <span>Email: muster@mustermail.xy</span>
            </p>
            ...
            <p>
                <span>[The following information must be added if an external data protection officer has been appointed].</span>
            </p>
            <p>
                <span>Any street 1</span>
                <br/>
            ...
            <p>
                ...
                <span>Fax: Fax number</span>
                <br/>
                <span>Email: datenschutz@mustermail.xy</span>
            </p>
